...
namespace FlappyBird
{
     ...
     *
     * Klasa flappyObstacle dziedziczy po roznych klasach, aby dostarczyc funkcjonalnosci
     * zwiazanej z transformacja, kolizjami, ksztaltem, obsluga obiektow bitowych oraz aktualizacja.
     */
